...
// we only need this set to display the image in the library
            ...
            var media_upload = (media_upload_MediaUpload);
            ...
            function _uploadMedia() {
                _uploadMedia = Object(asyncToGenerator["a" /* default */])(
                    ...
                    regenerator_default.a.mark(function _callee(_ref) {
                        var allowedTypes, _ref$additionalData, additionalData, filesList, maxUploadFileSize,
                            _ref$onError, onError, onFileChange, _ref$wpAllowedMimeTyp, wpAllowedMimeTypes, files,
                            filesSet, setAndUpdateFiles, isAllowedType, allowedMimeTypesForUser,
                            isAllowedMimeTypeForUser, triggerError, validFiles, _iteratorNormalCompletion,
                            _didIteratorError, _iteratorError, _iterator, _step, _mediaFile, idx, mediaFile, savedMedia,
                            mediaObject, message;
...
// CONCATENATED MODULE: ./node_modules/@wordpress/media-utils/build-module/index.js
            ...
            /* concated harmony reexport uploadMedia */
