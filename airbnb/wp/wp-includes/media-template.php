...
function wp_print_media_templates()
{
    ...
    <script type="text/html" id="tmpl-uploader-inline">
        ...
        <button class="close dashicons dashicons-no"><span
                    class="screen-reader-text"><?php _e('Close uploader'); ?></span></button>
        <# } #>
    ...
    <script type="text/html" id="tmpl-media-library-view-switcher">
        ...
        <a href="<?php echo esc_url(add_query_arg('mode', 'grid', $_SERVER['REQUEST_URI'])); ?>"
    ...
    <script type="text/html" id="tmpl-uploader-status">
        ...
        <button type="button" class="button-link upload-dismiss-errors"><span
                    class="screen-reader-text"><?php _e('Dismiss Errors'); ?></span></button>
    ...
    <script type="text/html" id="tmpl-edit-attachment-frame">
        <div class="edit-media-header">
            ...
            <# if ( ! data.hasPrevious ) { #> disabled<# } #>><span
                    class="screen-reader-text"><?php _e('Edit previous media item'); ?></span></button>
            <button class="right dashicons"
            <# if ( ! data.hasNext ) { #> disabled<# } #>><span
                    class="screen-reader-text"><?php _e('Edit next media item'); ?></span></button>
            <button type="button" class="media-modal-close"><span class="media-modal-icon"><span
                            class="screen-reader-text"><?php _e('Close dialog'); ?></span></span></button>
        </div>
            ...
            <div class="settings">
                ...
                <span class="setting">
						...
						<# if ( data.uploadedToLink ) { #>
							<span class="value"><a
                                        href="{{ data.uploadedToLink }}">{{ data.uploadedToTitle }}</a></span>
						<# } else { #>
    ...
    <script type="text/html" id="tmpl-attachment-details">
        ...
        foreach (array(
			...
			<input type="text" id="attachment-details-<?php echo esc_attr($key); ?>"
                   value="{{ data.<?php echo $key; ?> || data.meta.<?php echo $key; ?> || '' }}"/>
		</span>
        <?php endforeach; ?>
        <# } #>
            ...
            <div class="embed-media-settings">
                ...
                <div class="column-image">
                    <div class="image">
                        ...
                        <div class="actions">
                            <input type="button" class="edit-attachment button"
                                   value="<?php esc_attr_e('Edit Original'); ?>"/>
                            <input type="button" class="replace-attachment button"
        ...
        <div class="media-embed media-embed-details">
            <div class="embed-media-settings embed-audio-settings">
                ...
                foreach ($audio_types as $type) :
					...
					<input type="text" id="audio-details-<?php echo $type . '-source'; ?>" readonly
                           data-setting="<?php echo $type; ?>" value="{{ data.model.<?php echo $type; ?> }}"/>
					<button type="button"
                            class="button-link remove-setting"><?php _e('Remove audio source'); ?></button>
				</span>
                    <# } #>
            ...
            <div class="embed-media-settings embed-video-settings">
                <div class="wp-video-holder">
					...
					<label for="video-details-<?php echo $type . '-source'; ?>"
                           class="name"><?php echo strtoupper($type); ?></label>
					<input type="text" id="video-details-<?php echo $type . '-source'; ?>" readonly
                           data-setting="<?php echo $type; ?>" value="{{ data.model.<?php echo $type; ?> }}"/>
					<button type="button"
                            class="button-link remove-setting"><?php _e('Remove video source'); ?></button>
				</span>
