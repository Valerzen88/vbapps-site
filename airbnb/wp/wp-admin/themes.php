...
?>
    ...
    <div class="wrap">
        <h1 class="wp-heading-inline"><?php esc_html_e('Themes'); ?>
            <span
                class="title-count theme-count"><?php echo !empty($_GET['search']) ? __('&hellip;') : count($themes); ?></span>
        </h1>
        ...
        if (!validate_current_theme() || isset($_GET['broken'])) {
            ...
            ?>
            <div id="message6" class="error">
                <p><?php _e('Theme could not be resumed because it triggered a <strong>fatal error</strong>.'); ?></p>
            </div>
            <?php
        }
        ...
        <div class="<?php echo esc_attr($class_name); ?>">
            <div class="themes wp-clearfix">
                ...
                foreach ($themes as $theme) :
                    ...
                    ?>
                    <div class="theme<?php echo $active_class; ?>" tabindex="0"
    ...
    <script id="tmpl-theme" type="text/template">
        ...
        <div class="theme-id-container">
            ...
            <div class="theme-actions">
                ...
                $aria_label = sprintf(_x('Activate %s', 'theme'), '{{ data.name }}');
                ?>
                <a class="button activate" href="{{{ data.actions.activate }}}"
